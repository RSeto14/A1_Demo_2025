...
def a1_xml(additional_trunk_mass=0.0, limb_mass_scaling_factor=1.0, skeleton=True):
    ...
    <!-- <mujoco model="a1"> -->
        ...
        <worldbody>
            <light name="spotlight1" mode="targetbodycom" target="trunk" pos="5 -5 5" diffuse="0.8 0.8 0.8"/>
            <!--<light name="spotlight2" mode="targetbodycom" target="trunk" pos="3 -3 10" diffuse="0.8 0.8 0.8"/>-->
            <!--<light name="spotlight3" mode="targetbodycom" target="trunk" pos="0 0 10" diffuse="0.8 0.8 0.8"/>-->
            <!--<camera name="camera_scshot" pos="2.299 -2.814 0.143" xyaxes="0.774 0.633 -0.000 -0.025 0.030 0.999"/>-->
            <camera name="camera_scshot" pos="0.617 -0.550 0.532" xyaxes="0.697 0.717 -0.000 -0.316 0.306 0.898"/>
            ...
            <site name="bottom" pos="0 0 -0.057" size="0.125 0.075 0.01" type="box" rgba="0.0 1.0 0.0 0.0"/>
            ...
            <site name="bottom2" pos="0.25 0 -0.05" size="0.01 0.06" quat="1 1 0 0" type="capsule" rgba="0.0 1.0 0.0 0.0"/>
            ...
            <body name="FR_hip" pos="0.183 -0.047 0">
                ...
                <geom class="thigh2"/>
                <geom class="thigh3"/>
                <site name="FR_knee" fromto="-0.02 0 -0.16 0 0 -0.2" size="0.02" type="capsule" rgba="0.0 1.0 0.0 0.0"/>
            ...
            <body name="FL_hip" pos="0.183 0.047 0">
                ...
                <geom class="thigh2"/>
                <geom class="thigh3"/>
                <site name="FL_knee" fromto="-0.02 0 -0.16 0 0 -0.2" size="0.02" type="capsule" rgba="0.0 1.0 0.0 0.0"/>
            ...
            <body name="RR_hip" pos="-0.183 -0.047 0">
                ...
                <geom class="thigh2"/>
                <geom class="thigh3"/>
                <site name="RR_knee" fromto="-0.02 0 -0.16 0 0 -0.2" size="0.02" type="capsule" rgba="0.0 1.0 0.0 0.0"/>
            ...
            <body name="RL_hip" pos="-0.183 0.047 0">
                ...
                <geom class="thigh2"/>
                <geom class="thigh3"/>
                <site name="RL_knee" fromto="-0.02 0 -0.16 0 0 -0.2" size="0.02" type="capsule" rgba="0.0 1.0 0.0 0.0"/>
        ...
        <actuator>
            <!-- <position class="abduction" name="FR_hip" joint="FR_hip_joint" kp="60" kv="1"/>
            <position class="hip" name="FR_thigh" joint="FR_thigh_joint" kp="60" kv="1"/>
            <position class="knee" name="FR_calf" joint="FR_calf_joint" kp="60" kv="1"/>
            <position class="abduction" name="FL_hip" joint="FL_hip_joint" kp="60" kv="1"/>
            <position class="hip" name="FL_thigh" joint="FL_thigh_joint" kp="60" kv="1"/>
            <position class="knee" name="FL_calf" joint="FL_calf_joint" kp="60" kv="1"/>
            <position class="abduction" name="RR_hip" joint="RR_hip_joint" kp="60" kv="1"/>
            <position class="hip" name="RR_thigh" joint="RR_thigh_joint" kp="60" kv="1"/>
            <position class="knee" name="RR_calf" joint="RR_calf_joint" kp="60" kv="1"/>
            <position class="abduction" name="RL_hip" joint="RL_hip_joint" kp="60" kv="1"/>
            <position class="hip" name="RL_thigh" joint="RL_thigh_joint" kp="60" kv="1"/>
            <position class="knee" name="RL_calf" joint="RL_calf_joint" kp="60" kv="1"/>-->
    ...
    <!--<mujoco model="a1">-->
        ...
        <default>
            ...
            <default class="collision">
                <geom group="0" type="capsule" rgba= "0.5 0.5 0.5 0.8"/>
                <!-- <geom group="3" type="capsule"/> -->
                <default class="hip_left">
                <geom size="0.04 0.04" quat="1 1 0 0" type="cylinder" pos="0 0.055 0"/>
                </default>
